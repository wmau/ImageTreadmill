...
%%
    ...
    for a=1:nAnimals 
        ...
        for s=1:nSessions
            ...
            codingCells = ismember(1:NumNeurons,intersect(codingCells,neurons))';
            
            %Get changes in information. 
            infoDelta{a}{s} = diff(sessionPairInfos{a}{s}(codingCells,:),[],2);
            
            originalInfos = [originalInfos; sessionPairInfos{a}{s}(codingCells,1)];
        end
