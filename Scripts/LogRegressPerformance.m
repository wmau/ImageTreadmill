...
timeFileName = fullfile(folder,'Time Log Regress');
placeFileName = fullfile(folder,'Place Log Regress');
...
[~,sTimeTIaccuracy,sTimeTIshuffle,sTimeTIp] = LogRegressStability(fulldataset,'time','TI');

disp('Classifying temporal stability based on spatial information.');
[~,sTimeSIaccuracy,sTimeSIshuffle,sTimeSIp] = LogRegressStability(fulldataset,'time','SI');

disp('Classifying temporal stability based on transient frequency.');
[~,sTimeFRaccuracy,sTimeFRshuffle,sTimeFRp] = LogRegressStability(fulldataset,'time','FR');

disp('Classifying spatial stability based on spatial information.');
[~,sPlaceSIaccuracy,sPlaceSIshuffle,sPlaceSIp] = LogRegressStability(fulldataset,'place','SI');

disp('Classifying spatial stability based on temporal information.');
[~,sPlaceTIaccuracy,sPlaceTIshuffle,sPlaceTIp] = LogRegressStability(fulldataset,'place','TI');

disp('Classifying spatial stability based on transient frequency.');
[~,sPlaceFRaccuracy,sPlaceFRshuffle,sPlaceFRp] = LogRegressStability(fulldataset,'time','FR');
