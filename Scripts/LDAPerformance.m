...
[~,sTimeTIaccuracy,sTimeTIshuffle,sTimeTIp] = LDAStability(fulldataset,'time','TI');

disp('Classifying temporal stability based on spatial information.');
[~,sTimeSIaccuracy,sTimeSIshuffle,sTimeSIp] = LDAStability(fulldataset,'time','SI');

disp('Classifying temporal stability based on transient frequency.');
[~,sTimeFRaccuracy,sTimeFRshuffle,sTimeFRp] = LDAStability(fulldataset,'time','FR');

disp('Classifying spatial stability based on spatial information.');
[~,sPlaceSIaccuracy,sPlaceSIshuffle,sPlaceSIp] = LDAStability(fulldataset,'place','SI');

disp('Classifying spatial stability based on temporal information.');
[~,sPlaceTIaccuracy,sPlaceTIshuffle,sPlaceTIp] = LDAStability(fulldataset,'place','TI');

disp('Classifying spatial stability based on transient frequency.');
[~,sPlaceFRaccuracy,sPlaceFRshuffle,sPlaceFRp] = LDAStability(fulldataset,'time','FR');
