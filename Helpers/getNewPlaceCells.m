...
%%
    ...
    %session 2. 
    newPCsS2 = matches(ismember(matches(:,2),DATA.placecells{2}),2);     %Cell numbers in session 2 of place cells in session 2.
    PCsfromS2 = matches(ismember(matches(:,2),DATA.placecells{2}),1);    %Cell numbers in session 1 of place cells in session 2. 
    PCsfromS1 = DATA.placecells{1};                                      %Cell numbers in session 1 of place cells in session 1. 
